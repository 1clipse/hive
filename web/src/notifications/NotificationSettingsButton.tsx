import { Bell, Check, Info, Play, Volume2, VolumeX, X } from 'lucide-react'
    ...
    <div ref={containerRef} className="relative">
      <Tooltip label={t('notifications.settings.tooltip')}>
        <button
          ...
          className="flex h-7 w-7 max-md:min-w-11 cursor-pointer items-center justify-center rounded text-sec hover:bg-3 hover:text-pri"
      ...
      {open ? (
        <div
          ...
          className={
            isMobile
              ...
              : 'elev-2 absolute top-8 right-0 z-50 w-[380px] rounded border p-3'
          }
          style={
            isMobile
              ? { background: 'var(--bg-0)' }
        ...
        >
          <div
            ...
            style={isMobile ? { borderColor: 'var(--border)' } : undefined}
          >
            ...
            {isMobile ? (
              <button
                ...
                className="flex h-11 w-11 shrink-0 items-center justify-center rounded text-sec hover:bg-3 hover:text-pri"
          ...
          <div className={isMobile ? 'flex-1 overflow-y-auto p-4' : 'contents'}>
                  ...
                  >
                    ...
                    {item.value !== 'off' ? (
                      <button
                        ...
                        className="absolute right-2 bottom-2 flex h-6 w-6 pointer-coarse:h-10 pointer-coarse:w-10 items-center justify-center rounded border text-sec transition-colors hover:bg-3 hover:text-pri"

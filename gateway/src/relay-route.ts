// Daemon↔gateway hop only. Keep byte-identical with src/shared/remote-relay-route.ts
// (Workers package cannot import src/). Magic HRT1 is not a valid M1 version byte.

export const RELAY_ROUTE_MAGIC = new Uint8Array([0x48, 0x52, 0x54, 0x31])
...
export const bytesToArrayBuffer = (data: Uint8Array): ArrayBuffer => {
